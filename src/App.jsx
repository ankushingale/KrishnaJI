...
const QUESTION_BANK = [
  ...
  { id: "GK9", question: "The Great Barrier Reef is located off the coast of which country?", answer: "Australia", hint: "Famous for its coral." },
  { id: "GK10", question: "What is the capital of Canada?", answer: "Ottawa", hint: "Located in the province of Ontario." },
  ...
  { id: "GK18", question: "Who wrote the 'Declaration of Independence'?", answer: "Thomas Jefferson", hint: "The third U.S. President." },
  { id: "GK19", question: "The Magna Carta was signed in which country?", answer: "England", hint: "In the year 1215." },
  ...
  { id: "GK27", question: "What is the study of earthquakes called?", answer: "Seismology", hint: "Starts with 'Seis...'" },
  { id: "GK28", question: "What force pulls objects toward the center of the Earth?", answer: "Gravity", hint: "Discovered by Isaac Newton." },
  { id: "GK29", question: "What is the main component of the sun?", answer: "Hydrogen", hint: "The lightest element." },
  { id: "GK30", question: "What is the full form of DNA?", answer: "Deoxyribonucleic acid", hint: "Carries genetic instructions." },
  ...
  { id: "GK37", question: "In what city is the famous 'La Sagrada Familia' church located?", answer: "Barcelona", hint: "Designed by Gaudí." },
  { id: "GK38", question: "Who wrote 'To Kill a Mockingbird'?", answer: "Harper Lee", hint: "An American novelist." },
  { id: "GK39", question: "What is the most famous work by sculptor Michelangelo?", answer: "David", hint: "A marble statue of a Biblical hero." },
  { id: "GK40", question: "Who wrote 'The Great Gatsby'?", answer: "F. Scott Fitzgerald", hint: "An American writer of the Jazz Age." },
  ...
  { id: "GK44", question: "What is the national sport of Japan?", answer: "Sumo Wrestling", hint: "Involves 'rikishi'." },
  ...
  { id: "GK49", question: "The Ashes is a Test cricket series played between which two countries?", answer: "England and Australia", hint: "A historic rivalry." },
  { id: "GK50", question: "Which country has won the most Olympic medals?", answer: "USA", hint: "United States of America." },

  // Technology
  { id: "GK51", question: "Who is the co-founder of Microsoft?", answer: "Bill Gates", hint: "Also a philanthropist." },
  { id: "GK52", question: "What does 'www' stand for?", answer: "World Wide Web", hint: "The global system of interconnected computer networks." },
  { id: "GK53", question: "The first successful Apple computer was called the Apple what?", answer: "Apple I", hint: "Released in 1976." },
  { id: "GK54", question: "What does CPU stand for?", answer: "Central Processing Unit", hint: "The brain of the computer." },
  { id: "GK55", question: "Who is the CEO of Tesla?", answer: "Elon Musk", hint: "Also associated with SpaceX." },
  { id: "GK56", question: "What social media platform is famous for its 'tweets'?", answer: "Twitter", hint: "Now known as X." },
  { id: "GK57", question: "What is the main programming language used for Android app development?", answer: "Kotlin", hint: "Previously it was Java." },
  { id: "GK58", question: "What does 'AI' stand for?", answer: "Artificial Intelligence", hint: "Machines simulating human intelligence." },
  { id: "GK59", question: "Which company developed the Python programming language?", answer: "It was an individual", hint: "Guido van Rossum." },
  { id: "GK60", question: "What does USB stand for?", answer: "Universal Serial Bus", hint: "A common connector for devices." },

  // General Knowledge
  { id: "GK61", question: "What is the capital of France?", answer: "Paris", hint: "Known as the City of Love." },
  { id: "GK62", question: "What is the currency of the United Kingdom?", answer: "Pound Sterling", hint: "Symbol is £." },
  { id: "GK63", question: "How many colors are in a rainbow?", answer: "7", hint: "ROYGBIV." },
  { id: "GK64", question: "What do you call a baby kangaroo?", answer: "Joey", hint: "Lives in its mother's pouch." },
  { id: "GK65", question: "What is the tallest mammal?", answer: "Giraffe", hint: "Known for its long neck." },
  { id: "GK66", question: "What is the main ingredient in guacamole?", answer: "Avocado", hint: "A green fruit." },
  { id: "GK67", question: "What is the largest ocean on Earth?", answer: "Pacific Ocean", hint: "Covers about a third of the surface." },
  { id: "GK68", question: "What is the human body's largest organ?", answer: "Skin", hint: "It covers your entire body." },
  { id: "GK69", question: "Who directed the movie 'Jurassic Park'?", answer: "Steven Spielberg", hint: "Also directed E.T." },
  { id: "GK70", question: "What is the boiling point of water in Celsius?", answer: "100", hint: "At standard atmospheric pressure." },
  { id: "GK71", question: "Which is the only mammal capable of sustained flight?", answer: "Bat", hint: "They are nocturnal." },
  { id: "GK72", question: "What type of fish is Nemo?", answer: "Clownfish", hint: "He lives in an anemone." },
  { id: "GK73", question: "What are the primary colors?", answer: "Red, Yellow, Blue", hint: "They can be mixed to create other colors." },
  { id: "GK74", question: "What is a group of lions called?", answer: "Pride", hint: "Associated with dignity and self-respect." },
  { id: "GK75", question: "Which country is famous for its tulips and windmills?", answer: "Netherlands", hint: "Also known as Holland." },
  { id: "GK76", question: "What is the main language spoken in Brazil?", answer: "Portuguese", hint: "Not Spanish." },
  { id: "GK77", question: "In Greek mythology, who is the god of the sea?", answer: "Poseidon", hint: "Brother of Zeus." },
  { id: "GK78", question: "What is the most consumed drink in the world after water?", answer: "Tea", hint: "Comes in many varieties." },
  { id: "GK79", question: "What does a sommelier specialize in?", answer: "Wine", hint: "A professional at a restaurant." },
  { id: "GK80", question: "What is the name of the galaxy we live in?", answer: "Milky Way", hint: "A barred spiral galaxy." },
  { id: "GK81", question: "What is the fear of spiders called?", answer: "Arachnophobia", hint: "A common phobia." },
  { id: "GK82", question: "How many sides does a hexagon have?", answer: "6", hint: "One more than a pentagon." },
  { id: "GK83", question: "Which element's chemical symbol is 'Fe'?", answer: "Iron", hint: "A strong metal." },
  { id: "GK84", question: "Who was the lead singer of the band Queen?", answer: "Freddie Mercury", hint: "Known for his powerful vocals." },
  { id: "GK85", question: "What is the name of the famous clock tower in London?", answer: "Big Ben", hint: "The nickname for the Great Bell." },
  { id: "GK86", question: "Who wrote 'The Odyssey'?", answer: "Homer", hint: "An ancient Greek epic poet." },
  { id: "GK87", question: "What is the fastest land animal?", answer: "Cheetah", hint: "Famous for its spots." },
  { id: "GK88", question: "What is the main gas found in the air we breathe?", answer: "Nitrogen", hint: "Makes up about 78% of the atmosphere." },
  { id: "GK89", question: "What is the world's largest island?", answer: "Greenland", hint: "Located between the Arctic and Atlantic oceans." },
  { id: "GK90", question: "What is the currency of Japan?", answer: "Yen", hint: "Symbol is ¥." },
  ...
  { id: "GK92", question: "How many bones are in the adult human body?", answer: "206", hint: "Babies are born with more." },
  { id: "GK93", question: "Which country gifted the Statue of Liberty to the USA?", answer: "France", hint: "A symbol of friendship." },
  { id: "GK94", question: "Who composed 'The Four Seasons'?", answer: "Antonio Vivaldi", hint: "An Italian Baroque composer." },
  { id: "GK95", question: "What is the main ingredient in hummus?", answer: "Chickpeas", hint: "A popular Middle Eastern dip." },
  { id: "GK96", question: "What is the largest animal on Earth?", answer: "Blue Whale", hint: "A marine mammal." },
  { id: "GK97", question: "Which movie won the first Academy Award for Best Picture?", answer: "Wings", hint: "A silent film from 1927." },
  { id: "GK98", question: "What is the only planet that rotates on its side?", answer: "Uranus", hint: "An ice giant." },
  { id: "GK99", question: "Which famous scientist developed the theory of relativity?", answer: "Albert Einstein", hint: "E=mc²." },
  { id: "GK100", question: "In which city were the first modern Olympic Games held?", answer: "Athens", hint: "The capital of Greece." },
];
